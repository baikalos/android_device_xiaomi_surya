...
$(call soong_config_set,lineage_health,fast_charge_node,/sys/class/power_supply/bms/fastcharge_mode)
...
# MiuiCamera
$(call inherit-product-if-exists, device/xiaomi/surya-miuicamera/device.mk)
